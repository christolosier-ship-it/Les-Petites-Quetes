...
describe('disposition des occurrences', () => {
  it('reporte une quête sans la qualifier d’échec', () => {
    const postponed = postponeQuestOccurrence(
      available,
      '2026-07-18',
      '2026-07-16',
      'updated',
    );
    expect(postponed).toMatchObject({ status: 'postponed', postponedTo: '2026-07-18', revision: 2 });
  });

  it('refuse un report dans le passé', () => {
    expect(() =>
      postponeQuestOccurrence(available, '2026-07-15', '2026-07-16', 'updated'),
