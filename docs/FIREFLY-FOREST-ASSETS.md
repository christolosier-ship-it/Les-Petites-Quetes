...
| `source/abbasid/river_1.swf` / `river_1.fla` | Tiny Speck / Glitch | [`glitch-locations`](https://github.com/tinyspeck/glitch-locations/tree/master/source/abbasid), CC0 | `terrain/river-abbasid.webp` | Lit sinueux et berge illustrée du ruisseau | Extraction fidèle de la frame statique officielle avec JPEXS, rendu transparent 2×, réduction à 900 px et conversion WebP ; aucun retracé |
...
Le lit sinueux et sa berge sont désormais l’asset officiel `river_1` du dépôt Tiny Speck `glitch-locations`. Les plaques de terrain, vaguelettes, rochers et roseaux Glitch masquent sa jonction avec le sol. Aucun champ d’eau dessiné localement ni aucune rivière SVG maison n’est conservé.
